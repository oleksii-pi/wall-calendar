...
const HOLIDAY_COUNTRY_WIKIPEDIA_LANGUAGES = {
  AD: "ca",
  AL: "sq",
  AR: "es",
  AT: "de",
...
function holidaySearchUrl(name) {
  const wikiLanguage =
    HOLIDAY_COUNTRY_WIKIPEDIA_LANGUAGES[holidayCountry] || "en";
  return `https://${wikiLanguage}.wikipedia.org/w/index.php?search=${encodeURIComponent(name)}`;
}
